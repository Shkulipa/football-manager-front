...
export const PrivacyPolicy = (): JSX.Element => {
	return (
		<div>
			<Htag tag="h2">Privacy Policy</Htag>
			<Ptag>
			...
			<Htag tag="h2">Interpretation and Definitions</Htag>
			<Htag tag="h3">Interpretation</Htag>
			<Ptag>
			...
			<Htag tag="h3">Definitions</Htag>
			<Ptag>For the purposes of this Privacy Policy:</Ptag>
			<ul>
				<li>
				...
				<li>
					Website refers to football manager, accessible from
					<a href="https://football-manager-front-sigma.vercel.app/">
						https://football-manager-front-sigma.vercel.app/
					</a>
				</li>
				<li>
			...
			<Htag tag="h2">Data are using in this website</Htag>
			<Ptag>
				The author does not bear any responsibility for the use of football
				data. This project was created solely for educational purposes to
				demonstrate the developer&apos;s skills, and not for commercial
				purposes. The author does not plan to make any money from this project.
				Commercial transactions on this site are solely donations.
			</Ptag>

			<br />
			<br />

			<Htag tag="h2">Collecting and Using Your Personal Data</Htag>
			<Htag tag="h3">Types of Data Collected</Htag>
			<Htag tag="h3">Personal Data</Htag>
			<Ptag>
			...
			<Htag tag="h3">Usage Data</Htag>
			<Ptag>Usage Data is collected automatically when using the Service.</Ptag>
			<Ptag>
			...
			<Htag tag="h3">Information from Third-Party Social Media Services</Htag>
			<Ptag>
			...
			<Htag tag="h2">Use of Your Personal Data</Htag>
			<Ptag>The Company may use Personal Data for the following purposes:</Ptag>
			<ul>
				<li>
			...
			<Htag tag="h2">Retention of Your Personal Data</Htag>
			<Ptag>
			...
			<Htag tag="h2">Transfer of Your Personal Data</Htag>
			<Ptag>
			...
			<br />
			<br />
			<Htag tag="h2">Delete Your Personal Data</Htag>
			<Ptag>
			...
			<br />
			<br />
			<Htag tag="h2">Disclosure of Your Personal Data</Htag>
			<Htag tag="h3">Business Transactions</Htag>
			<Ptag>
			...
			<Htag tag="h3">Law enforcement</Htag>
			<Ptag>
			...
			<Htag tag="h3">Other legal requirements</Htag>
			<Ptag>
			...
			<Htag tag="h2">Security of Your Personal Data</Htag>
			<Ptag>
			...
			<br />
			<br />
			<Htag tag="h2">Children&apos;s Privacy</Htag>
			<Ptag>
			...
			<br />
			<br />
			<Htag tag="h2">Links to Other Websites</Htag>
			<Ptag>
				Our Service may contain links to other websites that are not operated by
				Us. If You click on a third party link, You will be directed to that
				third partyt&apos;s site. We strongly advise You to review the Privacy
			...
			<br />
			<br />
			<Htag tag="h2">Changes to this Privacy Policy</Htag>
			<Ptag>
			...
			<Ptag>
				...
				<ul>
					<li>
						By email:{' '}
						<a href="mailto:caspernumlock@gmail.com">caspernumlock@gmail.com</a>
					</li>
					<li>
						linkedIn:{' '}
						<a href="https://www.linkedin.com/in/oleksii-shkulipa/">
							https://www.linkedin.com/in/oleksii-shkulipa/
						</a>
					</li>
					<li>
						By visiting this page on our website:{' '}
						<a href="https://shkulipa.vercel.app">
							https://shkulipa.vercel.app
						</a>
					</li>
				</ul>
			</Ptag>
